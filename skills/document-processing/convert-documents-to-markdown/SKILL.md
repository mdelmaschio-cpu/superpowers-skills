...
description: Convert Word, PowerPoint, Excel, OpenDocument, RTF, EPUB, CSV, and PDF files to GitHub-Flavored Markdown using the anydoc CLI
when_to_use: when a task needs the contents of an office document, spreadsheet, presentation, ebook, or PDF you cannot read directly
version: 1.0.0
languages: all
---
