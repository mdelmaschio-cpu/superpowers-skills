...
def main() -> int:
    parser = argparse.ArgumentParser(description="Search the bundled Fedlex Swiss Code of Obligations PDF.")
    parser.add_argument("--query", help="Keyword or phrase to search.")
    parser.add_argument("--article", help="CO article number to search, e.g. 97 or 257.")
