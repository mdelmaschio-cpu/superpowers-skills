...
python scripts/search_co_pdf.py --query "parola chiave"
python scripts/search_co_pdf.py --article 97
python scripts/search_co_pdf.py --article 97 --query "inadempimento"
