...
python scripts/search_cpc_pdf.py --query "parola chiave"
python scripts/search_cpc_pdf.py --article 59
python scripts/search_cpc_pdf.py --article 17 --query "proroga di foro"
