...
PDF_PATH = ROOT / "references" / "fedlex-rs-210-cc-20260701-it.pdf"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Search the bundled Fedlex Swiss Civil Code (CC/RS 210) PDF.")
    parser.add_argument("--query", help="Keyword or phrase to search.")
    parser.add_argument("--article", help="CC article number to search, e.g. 28 or 641.")
