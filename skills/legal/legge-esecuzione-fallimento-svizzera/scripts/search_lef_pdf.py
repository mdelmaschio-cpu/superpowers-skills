...
PDF_PATH = ROOT / "references" / "fedlex-rs-281-1-lef-20260101-it.pdf"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Search the bundled Fedlex Swiss Federal Act on Debt Collection and Bankruptcy (LEF/RS 281.1) PDF.")
    parser.add_argument("--query", help="Keyword or phrase to search.")
    parser.add_argument("--article", help="LEF article number to search, e.g. 38 or 271.")
