...
python scripts/search_ldip_pdf.py --query "parola chiave"
python scripts/search_ldip_pdf.py --article 5
python scripts/search_ldip_pdf.py --article 178 --query "arbitrato"
