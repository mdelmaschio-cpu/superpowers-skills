...
PDF_PATH = ROOT / "references" / "fedlex-rs-291-ldip-20260101-it.pdf"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Search the bundled Fedlex Swiss Private International Law Act (LDIP/RS 291) PDF.")
    parser.add_argument("--query", help="Keyword or phrase to search.")
    parser.add_argument("--article", help="LDIP article number to search, e.g. 5 or 178.")
