...
- Follows the core `superpowers:writing-skills` guidelines
...
- Skill has been tested (see the core `superpowers:writing-skills` skill for TDD process)
...
- **`superpowers:writing-skills`** (core plugin skill) - How to create well-tested skills
