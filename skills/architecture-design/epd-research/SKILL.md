...
when_to_use: when searching for EPDs for specific building materials, comparing environmental impact of alternative products by GWP, or finding EPDs for LEED MRc2 documentation
version: 1.0.0
languages: all
allowed-tools:
  - WebFetch
